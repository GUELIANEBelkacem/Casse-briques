...
HD_PWD='C:/Users/USER/Desktop/myCasseBrique/myCasseBrique.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log game_gen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source game_gen.tcl -notrace
