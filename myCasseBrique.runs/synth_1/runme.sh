...
HD_PWD='C:/Users/USER/Desktop/myCasseBrique/myCasseBrique.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_gen.tcl
